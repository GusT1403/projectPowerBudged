              ...
              <BrowserRouter>
                ...
                <Routes>
                  ...
                  <Route element={<ProtectedRoutes/>}>
                    ...
                    <Route path='/span' element={ <h1> <Span/> </h1> }/>
                    <Route path='/addspan' element={ <h1> <SpanForm/></h1>}/>
                    <Route path='/span/:id' element={ <h1> <SpanForm/> </h1> }/>
                    <Route path='/backhaul/:id' element={ <h1> <BackhaulForm/> </h1> }/>
                    <Route path='/bhgps/:id' element={ <h1> <BhgpsForm/> </h1> }/>
                    <Route path='/addbhgps' element={ <h1> <BhgpsForm/></h1>}/>
                    <Route path='/taps' element={ <h1> <Taps/> </h1> }/>
                    <Route path='/addtaps' element={ <h1> <TapsForm/> </h1> }/>
                    <Route path='/addtaps/:id' element={ <h1> <TapsForm/> </h1> }/>
                    <Route path='/split' element={ <h1> <Split/> </h1> }/>
                    <Route path='/addsplit' element={ <h1> <SplitForm/> </h1> }/>
                    <Route path='/addsplit/:id' element={ <h1> <SplitForm/> </h1> }/>
                  </Route>
                </Routes>
              </BrowserRouter>
            </TapProvider>
